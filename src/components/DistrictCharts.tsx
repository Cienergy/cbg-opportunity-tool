        ...
        <div className="panel-body chart-box">
          <ResponsiveContainer width="100%" height="100%">
            <AreaChart data={trajectory}>
              ...
              <Tooltip />
              <Legend />
              <Area type="monotone" dataKey="district" name="District only" stroke="#3b82f6" fill="rgba(59,130,246,0.18)" />
              <Area type="monotone" dataKey="addressable" name="With nearby GAs" stroke="#0d9488" fill="rgba(13,148,136,0.18)" />
            </AreaChart>
          </ResponsiveContainer>
        </div>
      </div>
          ...
          {gaBars.length === 0 ? (
            ...
            <ResponsiveContainer width="100%" height="100%">
              <BarChart data={gaBars} layout="vertical" margin={{ left: 24, right: 12 }}>
                ...
                <Tooltip />
                <Legend />
                <Bar dataKey="now" name="Today TPD" fill="#3b82f6" />
                <Bar dataKey="y5" name="5Y TPD" fill="#0d9488" />
              </BarChart>
            </ResponsiveContainer>
          )}
        </div>
        ...
        <div className="panel-body chart-box">
          <ResponsiveContainer width="100%" height="100%">
            <BarChart data={infraGrowth}>
              ...
              <Tooltip />
              <Legend />
              <Bar dataKey="Today" fill="#f59e0b" radius={[2, 2, 0, 0]} />
              <Bar dataKey="Year 5" fill="#0d9488" radius={[2, 2, 0, 0]} />
            </BarChart>
          </ResponsiveContainer>
        </div>
      </div>
